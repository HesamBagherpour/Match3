...
namespace UnityEngine.Tilemaps
{
    ...
    public class AnimatedTileEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            int count = EditorGUILayout.DelayedIntField("Number of Animated Textures", tile.m_AnimatedSprites != null ? tile.m_AnimatedSprites.Length : 0);
            if (count < 0)
                count = 0;
            ...
            tile.m_TileColliderType=(Tile.ColliderType) EditorGUILayout.EnumPopup("Collider BlockType", tile.m_TileColliderType);
