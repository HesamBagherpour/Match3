...
namespace UnityEditor
{
    ...
    public class RandomBrushEditor : GridBrushEditor
    {
        ...
        public override void OnPaintInspectorGUI()
        {
            ...
            EditorGUI.BeginChangeCheck();
            randomBrush.randomTileSetSize = EditorGUILayout.Vector3IntField("Tile CreateAndAssign Size", randomBrush.randomTileSetSize);
            ...
            if (randomTileSetCount > 0)
            {
                ...
                {
                    EditorGUILayout.LabelField("Tile CreateAndAssign " + (i+1));
