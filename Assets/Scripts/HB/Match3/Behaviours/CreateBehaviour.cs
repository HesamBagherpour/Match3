...
namespace HB.Match3.Behaviours
{
    public class CreateBehaviour
    {
        ...
        public CreateBehaviour(Board board, IBoardView boardView, BlockFactory blockFactory, BoardData data, Random random)
        {
            _board = board;
            _boardData = data;
        ...
        public void CreateBoard(Action onFinished)
        {
            ...
            if (PuzzleController.IsCouponEvent) SetCoupons();
        ...
        private void CreateLockCellQuests()
        {
            ...
            {
                Cell cell = _board.Cells[lockQuestPair.position.x, lockQuestPair.position.y];
        ...
        private void AddNeighborCells(LockQuestModule lockModuleQuest, Cell cell)
        {
        ...
        private static bool IsNotValidBlockForCoupon(Cell cell, BlockModule block)
        {
            return block == null
        ...
        private void SetAdjacents(Cell cell)
        {
            ...
            List<Cell> adjacents = new List<Cell>(4);
            Point[] directions =
            {
        ...
        private static bool IsRestrictedToCreateBlock(Cell cell)
        {
            return cell.IsLocked(ActionType.Spawn, Direction.Center);
        }

        private void CreateInitialBlockModule(Cell cell)
        {
        ...
        private static bool CanCreateBlockInCell(Cell cell)
        {
