...
namespace HB.Match3.Modules
{
    public class SofaModule : BaseModule
    {
        ...
        public void Init(Match3MainBoard.Board board)
        {
    ...
    public class SofaView : ModuleView
    {
        ...
        {
           //HB // if (Board.IsActive && QuestGiver.IsInQuest(aspectId))//HB
           if (QuestGiver.IsInQuest(aspectId))
            {
                //HB//var targetPos = Match3GameUi.QuestItemPosition(aspectId);////HB
