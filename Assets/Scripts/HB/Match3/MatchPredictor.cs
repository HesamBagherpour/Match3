...
namespace Garage.Match3
{
    public class MatchPredictor
    {
        ...
        private List<Cell> _otherCellsInPossibleMatch;
        #endregion
        ...
        {
            _board = board;
            _otherCellsInPossibleMatch = new List<Cell>();
        }
        ...
        public bool WillMatchBySwap(Cell cell, Cell otherCell)
        {
        ...
        private bool WallBetweenCells(Cell cell, Cell otherCell)
        {
            // (1,2) = > (0,2)
        ...
        private void SetPossibleMatch(Cell cell, Cell otherCell, bool ret)
        {
            if (ret)
            {
