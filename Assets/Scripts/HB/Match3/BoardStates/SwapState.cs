...
namespace Garage.Match3.BoardStates
{
    public class SwapState : BoardState
    {
        ...
        private void ListenToSwapAndSuggestIfNon()
        {
            ...
            Cell.SwapRequest += OnSwapRequest;
        ...
        private void OnSwapRequest(Point pos, Direction direction)
        {
            ...
            DiscardSuggest?.Invoke();
            Cell.SwapRequest -= OnSwapRequest;
            Cell cell = Agent.Cells[pos.x, pos.y];
        ...
        private void MoveBlocks(Cell cell, Cell otherCell, Action callback, bool sweep = false)
        {
            _moveCount = 0;
        ...
        private void ResetMoves(Cell cell, Cell otherCell, Action callback)
        {
            _moveCount = 0;
            BlockModule block = cell.GetModule<BlockModule>();
            BlockModule otherBlock = otherCell.GetModule<BlockModule>();
