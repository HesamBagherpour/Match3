...
namespace HB.Match3.Block
{
    public class BlockFactory
    {
        ...
        public BlockFactory(BlockType[] blockTypes, View.BoardViewData boardViewData, Random rand)
        {
        ...
        public void CreateBlock(MyCell cell, BlockType bt, bool falling = false)
        {
           ...
           //HB //if (PuzzleController.IsCouponEvent && falling) SetCoupon(blockModule);
        }
        ...
        public void CreateFallingBlock(MyCell cell)
        {
