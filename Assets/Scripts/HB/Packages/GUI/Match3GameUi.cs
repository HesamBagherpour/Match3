...
using HB.Match3.Tutorial;
using HB.Match3.View.Quest;
using HB.Packages.GUI.Effect;
using TMPro;
using UnityEngine;
...
namespace HB.Packages.GUI
{
    public class Match3GameUi : Window
    {
        ...
        [SerializeField] private TextMeshPro _remainingMoves, _totalCoupons;
        [SerializeField] private TextMeshPro _levelNo;
